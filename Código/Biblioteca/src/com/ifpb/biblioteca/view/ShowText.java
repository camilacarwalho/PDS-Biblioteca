...
public class ShowText {
    ...
    public static void menuFuncionario(){
        ...
        System.out.println("4. Deletar esta conta");
        System.out.println("5. Ir para a gerencia de emprestimos");
        System.out.println("6. Ir para o gerencia de livros");
        System.out.println("7. Sair desta conta");
    }
    ...
    public static void readLivro(CadastroLivro crudL){
        ...
        Genero genero;
        switch (choise){
            case 1: genero = Genero.ROMANCE;
                    break;
            case 2: genero = Genero.TERROR;
                    break;
            case 3: genero = Genero.POESIA;
                    break;
            case 4: genero = Genero.FANTASIA;
                    break;
            case 5: genero = Genero.AVENTURA;
                    break;
            case 6: genero = Genero.BIOGRAFIA;
                    break;
            case 7: genero = Genero.DIDATICO;
                    break;
            default: genero = Genero.ROMANCE;
        }
        Autor autor = null;
